...
fof(eps_subst5, plain, [! [X]: (? [Y]: (~p(Y) & p(X)) <=> (~p(# [Y]: ((~p(Y) & p(X)))) & p(X))),$r1] --> [! [X]: (~p(# [Y]: ((~p(Y) & p(X)))) & p(X))], inference(rightSubstPred, [status(thm), 0, 0, 'HOLE', $fof(! [X]: HOLE(X))], [neg_conjecture_nnf])).
fof(sko_cut5, plain, [$r1] --> [! [X]: (~p(# [Y]: ((~p(Y) & p(X)))) & p(X))], inference(cut, [status(thm), 0], [sko_iff5, eps_subst5])).
fof(sko_subst5, plain, [! [X]: # [Y]: ((~p(Y) & p(X))) = Sk5(X),$r1] --> [! [X]: (~p(Sk5(X)) & p(X))], inference(rightSubstFun, [status(thm), 0, 0, 'THOLE', $fof(! [X]: (~p(THOLE(X)) & p(X)))], [sko_cut5])).
...
fof(ts_cla1, plain, [(Ts1(V0) <=> (~p(Sk5(V0)) & p(V0))),$r2,$r1] --> [~p(Sk5(V0)),~Ts1(V0)], inference(clausify, [status(thm), 0], [])).
...
fof(ts_clbQ1_1_p9r, plain, [$r3,$r2,$r1] --> [p(V0),~Ts1(V0)], inference(instMult, [status(thm), [tuple3('V0', $fot(V0), [])]], [ts_clbQ1_1])).
fof(ts_axQ1_1_p9r, plain, [$r3,$r2,$r1] --> [Ts1(V0)], inference(instMult, [status(thm), [tuple3('V0', $fot(V0), [])]], [ts_axQ1_1])).
fof(8, plain, [$r3,$r2,$r1] --> [p(Sk5(V100)),~Ts1(Sk5(V100))], inference(instMult, [status(thm), [tuple3('V0', $fot(Sk5(V100)), [])]], [ts_clbQ1_1_p9r])).
fof(9, plain, [$r3,$r2,$r1] --> [~p(Sk5(V100)),~Ts1(V100)], inference(instMult, [status(thm), [tuple3('V0', $fot(V100), [])]], [ts_claQ1_1_p9r])).
fof(10, plain, [$r3,$r2,$r1] --> [~Ts1(Sk5(V100)),~Ts1(V100)], inference(res, [status(thm), 0], [8, 9])).
fof(5, plain, [$r3,$r2,$r1] --> [~Ts1(Sk5(V0)),~Ts1(V0)], inference(instMult, [status(thm), [tuple3('V100', $fot(V0), [])]], [10])).
fof(11, plain, [$r3,$r2,$r1] --> [Ts1(Sk5(V100))], inference(instMult, [status(thm), [tuple3('V0', $fot(Sk5(V100)), [])]], [ts_axQ1_1_p9r])).
fof(12, plain, [$r3,$r2,$r1] --> [~Ts1(Sk5(V100)),~Ts1(V100)], inference(instMult, [status(thm), [tuple3('V0', $fot(V100), [])]], [5])).
fof(13, plain, [$r3,$r2,$r1] --> [~Ts1(V100)], inference(res, [status(thm), 0], [11, 12])).
fof(a06, plain, [$r3,$r2,$r1] --> [~Ts1(V0)], inference(instMult, [status(thm), [tuple3('V100', $fot(V0), [])]], [13])).
fof(14, plain, [$r3,$r2,$r1] --> [Ts1(V100)], inference(instMult, [status(thm), [tuple3('V0', $fot(V100), [])]], [ts_axQ1_1_p9r])).
fof(15, plain, [$r3,$r2,$r1] --> [~Ts1(V100)], inference(instMult, [status(thm), [tuple3('V0', $fot(V100), [])]], [a06])).
